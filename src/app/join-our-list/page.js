    ...
    return (
        <section className='relative overflow-y-hidden'>
            ...
            <div className='flex justify-center mt-8'>
                <Link href="#solution">
                    <div className='!py-[8px] px-[20px] border rounded-2xl border-transparent hover:border-[#313041] hover_insetshadow'>Borrowers</div>
                </Link>
                <Link href="#service">
                    <div className='!py-[8px] px-[20px] border rounded-2xl border-transparent hover:border-[#313041] hover_insetshadow'>Investors</div>
                </Link>
                <Link href="#partners">
                    <div className='!py-[8px] px-[20px] border rounded-2xl border-transparent hover:border-[#313041] hover_insetshadow'>Partners</div>
                </Link>
            </div>
            <div
