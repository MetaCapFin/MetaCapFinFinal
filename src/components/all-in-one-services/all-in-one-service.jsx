    ...
    return (
        <section id="service" className='text-white relative mt-14 md:mt-0'>
            <div className='flex justify-center'>
                <WButton>
                    <Image src="/assets/svg/illustrationhover.svg" alt="" width={20} height={20} />
                    All-in-One Service
                </WButton>
            </div>
                ...
                <Container className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:grid-cols-3 z-10 relative">
                    ...
                    <div className='insetshadow2 rounded-[20px] overflow-hidden py-6 border-[2px] border-[#2D2C3F] group'>
                        <figure className='flex gap-2 lg:h-[216px] -ml-6'>
                            <Image src="/assets/svg/illustrationhover.svg" alt='' width={170} height={170} className='w-[30%] group-hover:-translate-x-2 transition-all duration-700' />
                            <Image src="/assets/svg/illustrationhover.svg" alt='' width={170} height={170} className='w-[42%] group-hover:scale-110 transition-all duration-700' />
                            <Image src="/assets/svg/illustrationhover.svg" alt='' width={170} height={170} className='w-[30%] group-hover:ml-2 transition-all duration-700' />
                        </figure>
                        <div className='px-6'>
                        ...
                        <section className='max-w-[320px] mx-auto h-[216px] relative'>
                            <div className='flex justify-center'>
                                <div className='bg-[#4d4e5f]/20 rounded-[16px] absolute top-0 w-[70%] group-hover:top-5 transition-all duration-1000'>
                                    <Image src="/assets/svg/illustrationhover.svg" alt='' width={400} height={208} className='' />
                                </div>
                            </div>
                            <div className='flex justify-center'>
